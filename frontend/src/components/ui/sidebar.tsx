...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        'h-10 w-10 text-primary hover:text-primary hover:bg-transparent border-none rounded-lg [&>svg:last-child]:hidden',
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="group"
        className={cn('relative flex w-full min-w-0 flex-col px-6 py-2', className)}
        {...props}
      />
    );
  },
